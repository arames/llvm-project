//===- TestJoinMeetTypeInterface.cpp - Test Data Layout Queries -----------===//
//
...
void registerTestJoinMeetTypeInterface() {
  PassRegistration<TestJoinMeetTypeInterface>("test-join-meet-type-interface",
                                              "Test join/meet type interface");
}
} // namespace test
} // namespace mlir
